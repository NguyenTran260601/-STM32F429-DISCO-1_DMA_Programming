...
/* Some macro for DMA1 IT flag */
#define DMA1_HTIE_FLAG			(0x1U << 3)
#define DMA1_TCIE_FLAG			(0x1U << 4)
#define DMA1_TEIE_FLAG			(0x1U << 2)
#define DMA1_FEIE_FLAG			(0x1U << 7)
#define DMA1_DMEIE_FLAG			(0x1U << 1)
